# CITATION
   # The code in following files and folders was created by the team:
     # frontend:
         # all files in folders: components, pages
         # files: App.jsx
     # backend:
         # all files in folders: controllers, routes
         # files: ddl.sql

   # The remaining code was (either adapted or used as is) for the React-starter repo at: https://github.com/osu-cs340-ecampus/react-starter-app.git
